...
contract LiquidityPosition is IERC721Receiver {
    ...
    address public constant USDC = 0x8366dd3ff4807Fbec944F29fDf713b5d0436f3A9;
        ...
        )
    {
        ...
        uint amount0ToMint = 5 * 1e18;
        uint amount1ToMint = 5 * 1e18;
        ...
        // Note that the pool defined by CustomToken/USDC and fee tier 0.03% must 
        ...
        if (amount0 < amount0ToMint) {
            ...
            TransferHelper.safeTransfer(CustomToken, msg.sender, refund0);
        }
    ...
    {
        TransferHelper.safeTransferFrom(CustomToken, msg.sender, address(this), amountAdd0);
        TransferHelper.safeTransferFrom(USDC, msg.sender, address(this), amountAdd1);

        TransferHelper.safeApprove(CustomToken, address(nonfungiblePositionManager), amountAdd0);
